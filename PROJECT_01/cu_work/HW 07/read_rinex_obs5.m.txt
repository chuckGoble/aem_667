function [ rinexv3 ] = read_rinex_obs5(fname, PRN_list, max_epochs)
%*******************************************************
% function [ rinexv3 ] = read_rinex_obs(fname, PRN_list)
%
% DESCRIPTION:
%  
...
while (current_line ~= -1) & (epoch_count < max_epochs)
    ...
    for i = 1:num_sat_lines
        temp = fgetl(fid);
        current_line = [current_line(1:min(68,end)) temp(33:min(68,end))];
    end
